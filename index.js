...
function generateRandomPassword(length) {
  ...
  // Проходимось по кожному символу рядка characters.
  for (let i = 0; i < length; i++) {
    // Визначаємо випадковий індекс символу та отримуємо символ.
  ...
  // Повертаємо сгенерований пароль.
  return password;
}
  ...
  // Перевірка, чи переданий радіус є числом.
   if(isNaN(radius)){
      // Якщо радіус не є числом, виводимо в консоль повідомлення про помилку.
        ...
        console.log("Помилка: радіус має бути цілим числом");
    return null;
   }else{
...
function findMinMax(numbers) {
  ...
  console.error("Помилка параметр не є массивом")
...
function compareAndRound(num1, num2) {
  ...
  if (isNaN(num1) || isNaN(num2)) {
    // Виводимо повідомлення про помилку, якщо хоча б один аргумент не є числом.
